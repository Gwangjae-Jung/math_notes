...
\begin{proof}
    ...
    Because $\tau$ fixes $F$, $\tau$ permutes the roots of the minimal polynomial of $\alpha$ over $F$, so $\tau(\alpha)\in E$.
    ...
    Then, $\sigma$ extends to $\widetilde{\sigma}\in\emb{E/F}$, whose range is, by the assumption, $E$.
    Hence, $\beta\in E$, as desired.
...
\begin{obs}
    ...
    We wish to show that $K/E$ is a normal extension.
...
\begin{proof}
    ...
    To prove (c), let $\alpha$ be an element in $E_1\cap E_2$.
