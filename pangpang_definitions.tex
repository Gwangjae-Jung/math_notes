...
%\newcommand{\diy}[1]{\Huge{\textbf{\color{cyan}{#1} \color{black}}}}
...
\newcommand{\real}[1]{\textsf{Re}\left({#1}\right)}
\newcommand{\imag}[1]{\textsf{Im}\left({#1}\right)}
\newcommand{\esssup}[1]{\textsf{ess\,sup}{#1}}
