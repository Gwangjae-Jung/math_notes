...
\begin{sol}
    ...
    \end{align*}
    and $C\setminus U$ is compact (why?).

    \noindent\textbf{Step 3. Checking the axiom of intersection}\newline\indent
